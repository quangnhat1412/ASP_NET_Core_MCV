...
namespace Demo_Etity_Frameword_Core.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        {
            // Chèn tạo role tự động
            if (!_rolemanager.RoleExistsAsync(SD.Role_Cus).GetAwaiter().GetResult()) // Phải thực hiện xong mới tới những cái sau
            {
            ...
            // lấy role cung cấp cho trang thiết kế
            Input = new InputModel()
            {
                Rolelist = _rolemanager.Roles.Select(s => s.Name).Select(i => new SelectListItem { Text = i, Value = i })
            };
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        await _userManager.AddToRoleAsync(user, SD.Role_Cus);
                    }
